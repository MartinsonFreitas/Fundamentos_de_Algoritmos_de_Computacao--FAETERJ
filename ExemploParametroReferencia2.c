/*
	...
	NESSA NOVA IMPLEMENTAÇÃO, O ALUNO CORRIGIU O PROBLEMA; OU SEJA, TORNOU O 
	PARÂMETRO B COMO POR REFERÊNCIA!
*/
...
{
	a++;
	*b = (*b-a)/2;    //b:  endereço de memória onde encontra-se um float
					  //*b: o float que está no endereço armazenado por b; 
					  //em outras palavras, o conteúdo de b.		
}
